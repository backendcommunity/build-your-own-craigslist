# Mastering Backend - Online Marketplace API: Build Your Own Craigslist

![Design preview for the Online Marketplace API: Build Your Own Craigslist](https://pub-63da695b9ece47c5b3b49bd78b86d884.r2.dev/Online%20Marketplace%20API%20Build%20Your%20Own%20Craigslist.png)
...
The project is to build **Online Marketplace API: Build Your Own Craigslist** and get the front end working (the front end has already integrated the API).

[Click here to view more details about this project.](https://app.masteringbackend.com/projects/online-marketplace-api:-build-your-own-craigslist)
...
Your task is to Build Your Own Craigslist. You will find an SQLite database file called `db.sqlite` inside the root folder. You will find the front end of each project on the project description page. 
